...
public class Pathfinder
{
    ...
    public bool DFSToFuelSource(IGridMember gridCell, Fuel fuel, out List<PipeTemplate> path)
    {
        path = null;
    ...
    private List<PipeTemplate> FormPath(PipeTemplate refuelingPoint, Stack<PipeTemplate> removedTemplates, List<PipeTemplate> path)
    {
