        ...
        foreach (PipePiece pipePiece in pipeTemplate.PipePieces)
        {
            ...
            foreach (int[] offset in indexOffsets)
            {
                ...
                try
                {
                    ...
                    PipeDivider pipeDivider = _pipeDividers.FirstOrDefault(divider => (divider.Connection[0].SequenceEqual(cell1) &&
                ...
                {
                    if (pipePiece.GridPosition[0] + offset[0] == 2 && (pipePiece.GridPosition[1] + offset[1] == -1 || pipePiece.GridPosition[1] + offset[1] == _grid.Size))
                        connections[Array.IndexOf(indexOffsets, offset)] = true;
